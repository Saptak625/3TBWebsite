...
<div class="d-block container-fluid text-white bg-theme-orange">
  ...
  <div class="d-flex align-items-stretch py-4">
    ...
    <div class="w-25 ps-2 pe-4">
      <!--Twitter Content-->
      <a class="twitter-timeline" data-height="1850" data-theme="light" href="https://twitter.com/3tinybones?ref_src=twsrc%5Etfw">Tweets by 3tinybones</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
    </div>
</div>